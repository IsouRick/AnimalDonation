...
class _AnimalRegistrationPageState extends State<AnimalRegistrationPage> {
  ...
  // Função para salvar o animal no Firebase
  Future<void> _registerAnimal() async {
    ...
    if (userId != null) {
      ...
      try {
        ...
        // Exibir sucesso e limpar os campos
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              // Exibição da imagem do animal em formato circular
              CircleAvatar(
                radius: 60,
                backgroundColor: Colors.teal,
                backgroundImage:
              ...
              // Campo de texto para nome do animal
              TextField(
              ...
              const SizedBox(height: 20),
              // Campo de texto para tipo (cachorro, gato, etc)
              TextField(
